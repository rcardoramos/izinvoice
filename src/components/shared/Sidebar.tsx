  ...
  return (
    <aside className="w-64 bg-white text-zinc-700 flex flex-col border-r border-zinc-200 shrink-0 h-screen sticky top-0">
      ...
      <div className="p-6 border-b border-zinc-100 flex items-center gap-3">
        ...
        <div>
          <h1 className="font-semibold text-zinc-900 tracking-tight text-sm">INVOICEFLOW</h1>
        ...
        <div className="p-4 mx-4 my-3 rounded-xl bg-zinc-50 border border-zinc-150">
          <div className="flex items-center gap-2.5">
            ...
            <div className="min-w-0">
              <p className="text-xs font-semibold text-zinc-900 truncate">INVOICEFLOW HQ</p>
      ...
      {/* Footer Info */}
      <div className="p-4 border-t border-zinc-150 space-y-3">
        <div className="flex items-center gap-2.5">
          ...
          <div className="min-w-0 flex-1">
            <p className="text-[11px] font-semibold text-zinc-900 truncate">{user.fullName}</p>
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2 py-2.5 px-3 rounded-xl border border-zinc-200 text-[11px] font-semibold text-zinc-600 hover:text-zinc-900 hover:bg-zinc-50 transition-all cursor-pointer bg-white"
        >
